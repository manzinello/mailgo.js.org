...
<body>
...
<script src="https://cdn.jsdelivr.net/npm/mailgo@0.8.4/dist/mailgo.min.js"></script>
</body>
```
...
<body>
...
<script src="https://unpkg.com/mailgo@0.8.4/dist/mailgo.min.js"></script>
</body>
```
...
<head>
...
<script src="https://cdn.jsdelivr.net/npm/mailgo@0.8.4/dist/mailgo.min.js" defer></script>
</head>
```
...
<head>
...
<script src="https://unpkg.com/mailgo@0.8.4/dist/mailgo.min.js" defer></script>
</head>
```
...
```
https://cdn.jsdelivr.net/npm/mailgo@0.8.4/dist/mailgo.min.js
```

mailgo on unpkg

```
https://unpkg.com/mailgo@0.8.4/dist/mailgo.min.js
```
...
Download the script <a href="https://cdn.jsdelivr.net/npm/mailgo@0.8.4/dist/mailgo.min.js">here</a> and add it your page in body or head
