...
<body>
...
<script src="https://cdn.jsdelivr.net/npm/mailgo@0.6.7/dist/mailgo.min.js"></script>
</body>
```
...
<head>
...
<script src="https://unpkg.com/mailgo@0.6.7/dist/mailgo.min.js" defer></script>
</head>
```
...
<head>
...
<script src="https://cdn.jsdelivr.net/npm/mailgo@0.6.7/dist/mailgo.min.js" defer></script>
</head>
```
...
Download the script <a href="https://unpkg.com/mailgo@0.6.7/dist/mailgo.min.js">here</a> and add it your page in body or head
