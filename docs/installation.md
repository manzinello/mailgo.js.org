...
<body>
...
<script src="https://unpkg.com/mailgo@0.7.0/dist/mailgo.min.js"></script>
</body>
```
...
<body>
...
<script src="https://cdn.jsdelivr.net/npm/mailgo@0.7.0/dist/mailgo.min.js"></script>
</body>
```
...
<head>
...
<script src="https://unpkg.com/mailgo@0.7.0/dist/mailgo.min.js" defer></script>
</head>
```
...
<head>
...
<script src="https://cdn.jsdelivr.net/npm/mailgo@0.7.0/dist/mailgo.min.js" defer></script>
</head>
```
...
```
https://unpkg.com/mailgo@0.7.0/dist/mailgo.min.js
```

mailgo on jsDelivr

```
https://cdn.jsdelivr.net/npm/mailgo@0.7.0/dist/mailgo.min.js
```
...
Download the script <a href="https://unpkg.com/mailgo@0.7.0/dist/mailgo.min.js">here</a> and add it your page in body or head
