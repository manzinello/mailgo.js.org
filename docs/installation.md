...
<body>
  ...
  <script src="https://unpkg.com/mailgo@0.9.9/dist/mailgo.min.js"></script>
</body>
```
...
<head>
  ...
  <script
    src="https://cdn.jsdelivr.net/npm/mailgo@0.9.9/dist/mailgo.min.js"
    defer
  ></script>
</head>
```
...
<head>
  ...
  <script
    src="https://unpkg.com/mailgo@0.9.9/dist/mailgo.min.js"
    defer
  ></script>
</head>
```
...
```
https://unpkg.com/mailgo@0.9.9/dist/mailgo.min.js
```
...
Download the script <a href="https://cdn.jsdelivr.net/npm/mailgo@0.9.9/dist/mailgo.min.js">here</a> and add it your page in body or head
...
The dark mode is available through a configuration parameter (see more [here](/docs/dark-mode)) or substituting `mailgo.min.js` with `mailgo.dark.min.js`. From mailgo >= 0.9.9 you can also specify dark mode only for single modals.
